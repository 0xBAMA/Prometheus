...
// data/storage resources
	...
	AllocatedImage createImage ( void* data, VkExtent3D size, VkFormat format, VkImageUsageFlags usage, int bytesPerPixel = 4, string label = "", bool mipmapped = false ); // loaded from disk
